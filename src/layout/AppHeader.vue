    ...
    <header class="header-global">
        <base-nav class="navbar-main"  transparent type="primary" effect="light" expand>
            <router-link slot="brand" class="navbar-brand mr-lg-5" to="/">
                <img src="https://gatosyhumanos.com/wp-content/uploads/2018/04/cropped-logo-3.png" alt="logo">
            </router-link>

            <div class="row" slot="content-header" slot-scope="{closeMenu}">
                <div class="col-6 collapse-brand">
                    <a href="/">
                        <img src="https://gatosyhumanos.com/wp-content/uploads/2018/04/cropped-logo-3.png">
                    </a>
                </div>
