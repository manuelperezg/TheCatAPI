...
const SET_API_KEY         = '4d798a51-42ad-49e1-b89d-6afa753ee6db';
const SET_LAST_FAVOURITED = 'SET_LAST_FAVOURITED';
const SET_FAVOURITES      = 'SET_FAVOURITES';

axios.defaults.baseURL = process.env.VUE_APP_API_ENDPOINT;// "https://api.thecatapi.com/"
...
const merchants = {
  ...
  state: {
    ...
    images: null,
    api_key: "4d798a51-42ad-49e1-b89d-6afa753ee6db", // Swap this out with the one from the email sent after signing up
